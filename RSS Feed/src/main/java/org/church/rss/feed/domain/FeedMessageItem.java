...
public class FeedMessageItem implements org.church.management.interfaces.entity.Entity<FeedMessageKey>
{
	...
	{
		if(object instanceof FeedMessageItem)
		{
			FeedMessageItem that = (FeedMessageItem) object;
